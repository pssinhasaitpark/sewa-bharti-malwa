...
const DonationReceipt = () => {
    ...
    useEffect(() => {
        if (user) {
            const latestDonation = user.donations && user.donations.length > 0
            ...
            setFormData(prev => ({
                ...prev,
                name: user.full_name || '',
                receiptNumber: latestDonation ? latestDonation.receiptNo || 'SB/ONLINE/01' : 'SB/ONLINE/01',
                mobile: user.phone || '',
                ...
                ...(latestDonation && {
                    ...
                    panAadhar: latestDonation.panNumber || latestDonation.aadharNumber || '',
                                ...
                                <div className="col-12">
                                    <div className="alert alert-info">
                                        ...
                                        <small>
                                            ...
                                            भुगतान ID: {user.donations[user.donations.length - 1].paymentId} |
                                            स्थिति: {user.donations[user.donations.length - 1].paymentStatus} |
                                            दिनांक: {new Date(user.donations[user.donations.length - 1].createdAt).toLocaleDateString('hi-IN')}
                                        </small>
                                    </div>
                                </div>
                            </div>
