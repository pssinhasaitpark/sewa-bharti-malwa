...
import { IOCLLogo, ONGCLogo, SbiLogo } from "../../assets/index.js";
          ...
          <div className="col-lg-10">
                  ...
                  <div
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow =
                        "0 8px 25px rgba(255, 87, 51, 0.15)";
                    }}
                    onMouseLeave={(e) => {
            ...
            <div className="row" style={{ marginTop: "60px" }}>
              <div className="col-lg-8 mx-auto text-center">
                ...
                >
                  We are proud to work alongside these esteemed organizations in
                  our mission to serve society. Together, we strive to make a
